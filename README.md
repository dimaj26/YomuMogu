...
- **Gamified Start Menu & Mascot**: Beautiful bobbing cup mascot 🍵 that is interactive, wiggles, and shows random motivational phrases upon clicking. Features a persistent horizontal progression widget card (displaying levels, XP bar, and learning stats) embedded directly in the main column flow, a premium traditional Japanese Kumiko (Asanoha) geometric grid pattern with a warm washi paper texture background, and 3D overlay modals for Help documentation and Profile management.
