...
- Preserve module registry integrity. Adding/removing/renaming source files requires updating the [module-registry](module-registry-core.md) set (Route C).
