...
description: The src/ App Router directory tree — pages, API routes, hooks, core, plugins, components, lib, resources, services. Per-file roles are in module-registry.
---

# Directory Layout

Formerly `PROJECT_LOGIC.md` [PL-2.1]. High-level stack and flow are in [architecture](architecture.md); per-file roles in the [module-registry](module-registry-core.md) set.
