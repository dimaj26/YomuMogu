...
- [x] T013 Run the full [quickstart.md](quickstart.md) validation end-to-end across both runtimes (Scenarios 1–3). ✅ Claude Code (Scenario 1) + missing-prereq message (Scenario 3) verified during T005/install; opencode (Scenario 2) confirmed in T011
