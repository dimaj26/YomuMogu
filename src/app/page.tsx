    ...
    <div style={{ display: 'flex', flexDirection: 'column', minHeight: '100vh', backgroundColor: 'var(--bg-secondary)' }}>
      ...
      <main className={styles.dashboardContainer}>
        ...
        <h1 style={{ fontSize: '32px', fontWeight: 800, color: 'var(--text-primary)', marginBottom: '16px', lineHeight: '1.2' }}>
          {t("Превратите слова из Anki в живую речь!", "Ankiの単語を生きた言葉に！", 2)}
        </h1>

        <p style={{ fontSize: '16px', fontWeight: 600, color: 'var(--text-secondary)', marginBottom: '32px', maxWidth: '600px', lineHeight: '1.6' }}>
          {t(
            "YomuMogu импортирует ваши японские карточки Anki и помогает вам практиковать их в диалоге с ИИ-тьютором Gemini.",
            "YomuMoguはAnkiカードをインポートし、GeminiAI家庭教師との対話で練習するのを助けます。",
            2
          )}
        </p>
            ...
            <div className={styles.tabContent}>
              {helpTab === 'about' && (
                <div>
                  ...
                  <p>
                    {t(
                      "Классические приложения (включая Anki) часто тренируют пассивное узнавание. YomuMogu предлагает активную генерацию речи. ИИ Gemini вовлекает вас в контекстную беседу, вынуждая вспоминать и использовать целевые слова на японском языке.",
                      "一般的なアプリ（Ankiを含む）は受動的な記憶力を鍛えます。YomuMoguは能動的なアウトプットを促します。Gemini AIが目標単語を使うように自然と会話を誘導します。",
                      2
                    )}
                  </p>
                  <p>
