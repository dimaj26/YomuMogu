...
// Окно учёта активности (последние N действий) и минимум для показа фактической доли.
export const BALANCE_ACTIVITY_WINDOW = 30;
export const BALANCE_MIN_ACTIVITIES = 6;
